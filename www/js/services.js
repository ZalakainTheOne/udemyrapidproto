angular.module('udemyrapidproto.services', [])

.constant('FIREBASE_URL', 'https://logiticalstockapp.firebaseIO.com/')
...
.factory('searchService', function($q, $http, encodeURIService) {
  ...
  return {
    ...
    search: function(query) {
      ...
      url = 'http://d.yimg.com/aq/autoc?query=' + encodeURIService.encode(query) + '&region=US&lang=en-US&callback=YAHOO.Finance.SymbolSuggest.ssCallback';
